...
export default function FacturesDevisPage() {
  ...
  async function fetchProducts() {
    ...
    if (error) {
      console.error("fetchProducts error", { message: error?.message, details: error?.details, hint: error?.hint, code: error?.code });
      setProducts([]);
      ...
      {openCreate && (
        <div style={overlayStyle} onMouseDown={closeCreateModal}>
          <div style={modalStyle} onMouseDown={(e) => e.stopPropagation()}>
            ...
            <div style={modalBodyStyle}>
              <FormFields form={form} setField={setField as any} clients={clients} products={products} onAddClient={openClientCreate} />
